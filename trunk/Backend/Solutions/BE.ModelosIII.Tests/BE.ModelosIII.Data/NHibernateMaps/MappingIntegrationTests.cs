...
namespace BE.ModelosIII.Tests.BE.ModelosIII.Data.NHibernateMaps
{
    using System.IO;
    ...
    using global::BE.ModelosIII.Infrastructure.NHibernateMaps;
    ...
    public class MappingIntegrationTests
    {
        ...
        public virtual void SetUp()
        {
            ...
            var generator = new AutoPersistenceModelGenerator().Generate();
            generator.WriteMappingsTo("../../../../database/");
            this.configuration = NHibernateSession.Init(
                new SimpleSessionStorage(),
                mappingAssemblies,
                generator,
                "../../../../Solutions/BE.ModelosIII.Mvc/NHibernate.config");
        }
